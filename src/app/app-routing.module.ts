...
const routes: Routes = [
  {path:"admin", component:LayoutComponent,children:[
    ...
    {path: "roles",
    loadChildren: () => import("./admin/components/role/role.module")
  ...
  {path: "password-reset",
  loadChildren: ()=> import("./ui/components/password-reset/password-reset.module")
  .then(module => module.PasswordResetModule)},
  {path: "update-password/:userId/:resetToken",
  loadChildren: ()=> import("./ui/components/update-password/update-password.module")
